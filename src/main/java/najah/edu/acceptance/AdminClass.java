...
public class AdminClass {
    ...
    public void addHousingUnit() {
        ...
        if (addUnitOption.equals(addUnitOption)) {
            ...
            System.out.print("Enter the price of the home: ");
...
/*public static void arrylist() {
	...
	HousingAdvertisement ad1 = new HousingAdvertisement("Title 1", "Description 1","Nablus");
    HousingAdvertisement ad2 = new HousingAdvertisement("Title 2", "Description 2","Ramallah");
	}*/
